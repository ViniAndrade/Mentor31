            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    <a href="{{ route('app.demand.index') }}">
                        <img src="{{asset('img/report.png')}}" style="padding-bottom: 0.4em;"></i> <span>Demandas</span>
                    </a>
                    @if(Auth::check())
                        @if(Auth::user()->roles == 3 )
                            <a href="{{ route('app.mentor.index') }}">
                                 <img src="{{asset('img/mentor.png')}}" style="padding-bottom: 0.4em; padding-right: 0.4em;"><span>Mentores</span>
                            </a>
                        @endif
                    @endif
					
					<a href="{{ route('app.eventos.index') }}">
                          <img src="{{asset('img/calendar.png')}}" style="padding-bottom: 0.4em; padding-right: 0.1em;"></i> <span>Eventos</span>
 					</a>
 					<a href="{{ route('app.oportunidades.index') }}">
                         <img src="{{asset('img/briefcase.png')}}" style="padding-bottom: 0.3em; padding-right: 0.3em;" ><span>Oportunidades</span>
 					</a>
                </li>
